...
include('./static/js/components/adaptiveCards.js');
...
include('./static/js/components/auth.js');
include('./static/js/components/visualPanel.js');
include('./static/js/components/sessionSidebar.js');
