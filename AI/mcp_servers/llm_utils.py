    ...
    def _initialize_clients(self):
        ...
        if bedrock_enabled:
            try:
                ...
                logger.warning(f"⚠️ Bedrock initialization failed: {_redact_secrets(str(e))}")
        ...
        if self.groq_api_key:
            try:
                ...
                logger.warning(f"⚠️ GROQ initialization failed: {_redact_secrets(str(e))}")
        ...
        if use_vertex:
            try:
                ...
                logger.warning(f"⚠️ Vertex Gemini initialization failed: {_redact_secrets(str(e))}")
        ...
        if self.google_api_key:
            try:
                ...
                logger.warning(f"⚠️ Google Gemini initialization failed: {_redact_secrets(str(e))}")
    ...
    async def _call_groq(self, prompt: str) -> LLMResponse:
        ...
        try:
            ...
            if is_rate_limit or is_server_error:
                ...
                logger.warning(f"⚠️ GROQ rate limited/error: {_redact_secrets(str(e))}")
            else:
                logger.error(f"❌ GROQ call failed: {_redact_secrets(str(e))}")
    ...
    async def _call_google(self, prompt: str) -> LLMResponse:
        ...
        try:
            ...
            if is_rate_limit or is_server_error:
                ...
                logger.warning(f"⚠️ Google rate limited/error: {_redact_secrets(str(e))}")
            else:
                logger.error(f"❌ Google call failed: {_redact_secrets(str(e))}")
