...
class HybridRouter:
    ...
    def _get_predefined_response(self, intent: str) -> str:
        """Get a predefined response for a small-talk intent."""
        responses = {
            "greet": [
            ...
            "bot_challenge": [
                "I am a virtual assistant powered by AI. How can I help you today?",
                "I'm an AI chatbot here to assist you!",
            ],
            "bot_capabilities": [
                "I can help you with weather information, news, leave management, surveys, and more! Just ask me anything.",
                "I'm here to assist with various tasks including checking the weather, getting news, managing leave requests, and answering questions about your organization.",
            ],
        }
        
        intent_responses = responses.get(intent, ["I'm here to help! What would you like to know?"])
        
        # Rotate through responses for variety
        if intent not in self._response_index:
            self._response_index[intent] = 0
        
        idx = self._response_index[intent] % len(intent_responses)
        self._response_index[intent] = idx + 1
        
        return intent_responses[idx]
